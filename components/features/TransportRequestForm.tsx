...
const DESTINATIONS: Destination[] = [
  ...
  { id: 'el_llano',         emoji: '🌳',  name: 'El Llano (Parque Juárez)',                                priceUsd: 20,  duration: '10–20 min' },
  { id: 'zocalo',           emoji: '🏛️',  name: 'Zócalo (Historic Main Square)',                           priceUsd: 25,  duration: '12–25 min' },
  { id: 'monte_alban',      emoji: '🗿',  name: 'Monte Albán (Archaeological Site)',                       priceUsd: 80,  duration: '20–35 min' },
  { id: 'ado_station',      emoji: '🚌',  name: 'ADO Bus Station',                                         priceUsd: 30,  duration: '15–25 min' },
  { id: 'hierve_el_agua',   emoji: '💧',  name: 'Hierve el Agua (Petrified Waterfalls)',                   priceUsd: 200, duration: '1.5–2.5 hrs · full-day recommended' },
  { id: 'arbol_tule',       emoji: '🌲',  name: 'Árbol del Tule (Tree of Tule)',                           priceUsd: 40,  duration: '20–35 min' },
