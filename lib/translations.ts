export const translations = {
  en: {
    ...
    book: {
      ...
      email: "Email",
      phone: "Phone",
      contactNote: "Email is required. Phone number is optional — provide it to receive booking updates via WhatsApp or SMS.",
      unit: "Unit",
      guests: "Guests",
      checkIn: "Check-in",
      checkOut: "Check-out",
  ...
  es: {
    ...
    book: {
      ...
      phone: "Teléfono",
      contactNote: "El correo electrónico es obligatorio. El teléfono es opcional — ingrésalo para recibir actualizaciones por WhatsApp o SMS.",
      unit: "Unidad",
